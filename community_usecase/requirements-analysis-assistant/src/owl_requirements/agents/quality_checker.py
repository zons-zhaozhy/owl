...
class QualityChecker(BaseAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        """初始化质量检查智能体"""
        super().__init__("QualityChecker", config)
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 解析响应
            quality_result = self._parse_llm_response(response)
    ...
    async def check_completeness(self, requirements: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        """便捷方法：完整性检查"""
    ...
    async def check_consistency(self, requirements: Dict[str, Any], analysis: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        """便捷方法：一致性检查"""
        result = await self.process({
            "requirements": requirements,
    ...
    async def check_clarity(self, requirements: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        """便捷方法：清晰度检查"""
        result = await self.process({
            "requirements": requirements,
            **kwargs
    ...
    def get_quality_summary(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 收集所有问题
        all_issues = []
        for check_type in ["completeness_check", "consistency_check", "clarity_check", "feasibility_check", "testability_check"]:
        ...
        return {
            ...
            "priority_issues": quality_report.get("overall_assessment", {}).get("priority_issues", []),
            "strengths": quality_report.get("overall_assessment", {}).get("strengths", []),
            "weaknesses": quality_report.get("overall_assessment", {}).get("weaknesses", [])
        }
    ...
    async def check(self, requirements: Dict[str, Any], analysis: Dict[str, Any] = None, context: Optional[str] = None) -> Dict[str, Any]:
